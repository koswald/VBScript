...
Class WMIUtility
    ...
    'Remark: Terminates a process with the specified id, name, and delay, asynchronously.
    ...
    Sub TerminateProcessByIdAndNameDelayed(id, name, milliseconds)
        ...
        stream.WriteLine "fso.DeleteFile WScript.ScriptFullName"
        stream.WriteLine "Set fso = Nothing"
        stream.Close
        Set stream = Nothing
        ts.Run 'the Run method is asynchronous by default: program execution does not halt
    End Sub
