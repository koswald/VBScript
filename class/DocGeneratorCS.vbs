...
Class DocGeneratorCS
    ...
    'Parameters: -
    'Returns: -
    'Remarks: Required. Gets or sets the html output file. Older versions, if any, will be overwritten. Relative paths and environment variables are supported.
    Property Get HtmlFile : HtmlFile = htmlFile_ : End Property
    Property Let HtmlFile(newValue) : htmlFile_ = sh.ExpandEnvironmentStrings(newValue) : End Property

    'Method Generate
    'Remarks: Generates an html document based on the .xml files generated by the C# compiler.
    Sub Generate
        ValidateXmlFolder
        WriteHtmlHeader
        Dim file
    ...
    Sub WriteHtmlHeader
        On Error Resume Next
            ...
            If Err Then MsgBox "Use the HtmlFile property to set the output file.", vbInformation, "DocGeneratorCS class" : Class_Terminate : WScript.Quit
        On Error Goto 0
    ...
    Private xmlFolder_
    Private xml, html
    Private xmlFiles, xmlFile, htmlFile_
    Private fso, sh, f
