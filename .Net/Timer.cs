...
namespace VBScripting
{
    ...
    public class Timer : ITimer
    {
        ...
        /// <summary> Gets or sets the number of milliseconds between when the Start method is called and when the callback is invoked. Default is 60,000. Max is 2,147,483,647 milliseconds, or 24 days 20 hours 31 minutes 23.647 seconds.</summary>
